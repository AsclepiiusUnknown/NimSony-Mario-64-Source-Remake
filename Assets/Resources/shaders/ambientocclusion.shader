			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat9 = _ZBufferParams.x * u_xlat10_2.x + _ZBufferParams.y;
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat8 = _ZBufferParams.x * u_xlat10_1.x + _ZBufferParams.y;
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.x = exp2(u_xlat0.x);
					    u_xlat10_2 = texture(_CameraDepthTexture, vs_TEXCOORD0.xy);
					    u_xlat8 = _ZBufferParams.x * u_xlat10_2.x + _ZBufferParams.y;
					    u_xlat8 = float(1.0) / u_xlat8;
					    u_xlat8 = u_xlat8 * _ProjectionParams.z + (-_ProjectionParams.y);
					    u_xlat8 = u_xlat8 * _FogParams.x;
					    u_xlat8 = u_xlat8 * (-u_xlat8);
